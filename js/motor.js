    ...
    if (localStorage.getItem('cocheAsegurado') === null) {
        ...
        for (var i = 0; i < cocheAsegurado.length; i++) {
            ...
            document.getElementById('demo').innerHTML =
                ...
                Descuento: ${cocheAsegurado[0].descuento} Tipo seguro: ${cocheAsegurado[0].tipoSeguro}</div> 
                <br>
                <div><img src="img/seat.png" height='auto' width='310'>
                <br>Marca: ${cocheAsegurado[1].coche} Año: ${cocheAsegurado[1].year}
                Descuento: ${cocheAsegurado[1].descuento} Tipo seguro: ${cocheAsegurado[1].tipoSeguro}</div>
                <br>
                <div><img src="img/golf.png" height='auto' width='240'>
                <br>Marca: ${cocheAsegurado[2].coche} Año: ${cocheAsegurado[2].year}
